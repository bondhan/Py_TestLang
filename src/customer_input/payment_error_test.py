...
if __name__ == "__main__":
    # main(sys.argv[1:])
    sendPurchase("SN00000000000001", "001", "1000", "Pintu Tol Jor", "Pembayaran tol golongan 1", getRandom(12, False),
                 "999") # return no organization found

    sendPurchase("SN00000000000002", "001", "1000", "Pintu Tol Jor", "Pembayaran tol golongan 1", getRandom(12, False),
                 "001") # no data found
